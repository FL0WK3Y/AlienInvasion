...
bat = pygame.image.load(os.path.join('/Users/gregorirodriguez/Desktop/Udemy_Games/brake out /images/DurrrSpaceShip.png'))
bat = bat.convert_alpha() 
bat_rect = bat.get_rect()
bat_rect[1] = screen.get_height() - 100

ball = pygame.image.load(os.path.join('/Users/gregorirodriguez/Desktop/Udemy_Games/brake out /images/Fire-Ball.png'))
...
brick = pygame.image.load(os.path.join('/Users/gregorirodriguez/Desktop/Udemy_Games/brake out /images/ship_blue.png'))
